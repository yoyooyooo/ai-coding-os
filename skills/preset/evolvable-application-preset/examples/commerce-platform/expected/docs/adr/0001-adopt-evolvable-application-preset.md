...
建议采用 Evolvable Application Preset `1.3.1-experimental.1`，profiles：agent-entry, monorepo-core, typescript-node, react, effect, effect-httpapi-v4, verification-core, headless-product-harness, ui-product-harness。
