...
description: >-
  ...
  decision/uncertainty handoff, Proof Surface and the optional claim-bounded
  Evidence Envelope, eval assets, owner-declared architecture vocabulary,
  TypeScript filename patterns, guarded terms, and Harness schemas. Use when a Suite Skill
...
Owns:
  ...
  portable scope / claim / basis / issue / decision-right / invalidation semantics
  decision and uncertainty handoff vocabulary without a central registry
  portable catalog of owner-declared architecture/source vocabulary and TypeScript filename defaults
...
| Scoped claim, issue, decision-right, and invalidation handoff | [Decision and Uncertainty Contract](references/decision-and-uncertainty-contract.md) |
| Owner-declared architecture/source vocabulary | [Semantic Vocabulary](references/semantic-vocabulary.yaml) |
| Optional TypeScript semantic filename patterns | [Filename Patterns](references/filename-patterns.yaml) |
| Cross-Skill decision and uncertainty terms | [Decision and Uncertainty Contract](references/decision-and-uncertainty-contract.md) |
