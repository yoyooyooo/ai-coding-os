#!/usr/bin/env python3
"""Build the deterministic core `skills/**` bundle and release sidecars.

A project-level distribution may package `docs/**` beside this core archive, but
this tool deliberately keeps the portable Skill-source claim separate.
"""
...
def archive_sources(suite_root: Path) -> list[tuple[str, bytes, int]]:
    ...
    repository-root README/docs, project code, package metadata, or repository release support
    would make this archive claim a broader distribution surface than the portable
    Core Skill Suite.
    """
...
def write_sidecar_reports(
    *,
    ...
    change_lines = [
        ...
        "- Project docs, repository shell, product code, release support, and generated distribution artifacts are outside this portable core ZIP claim.",
        "- A complete source distribution may package `docs/**` beside the Core ZIP while keeping their Authority and Evidence claims distinct.",
        "- Routes are discovery edges; owner-local coverage is not a fixed Agent workflow.",
        "",
        "## Minimal Knowledge Kernel",
        "",
        "- Project Authority First and Question-scoped Ownership.",
        "- One Scoped Meaning, One Current Home; Source Is Not Decision.",
        "- No Silent Material Assumption and Evidence Bounds Claims.",
        "- Strong Invariants, Weak Choreography; Minimal Context, Maximal Legibility.",
        "- Commitment-aware Autonomy and Earned Persistence.",
...
def main() -> None:
    ...
    manifest = {
        ...
        "archive_scope": {
            "includes": ["skills/**"],
            "excludes": ["docs/**", "project-source/**", "repository-shell/**", "release/**", "generated-distribution/**"],
        },
        "skills": skills,
        ...
        "notes": [
            ...
            "The ZIP contains only skills/**; project docs and complete-source packaging remain separate Authority/distribution surfaces.",
